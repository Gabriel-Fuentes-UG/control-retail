...
import { FaTachometerAlt, FaUsers, FaUserTag, FaHome, FaBoxOpen, FaTruckLoading } from "react-icons/fa";
...
export default function SideNav({ isCollapsed }: { isCollapsed: boolean }) {
  ...
  const availableLinks = allNavLinks.filter(link => userPermissions.includes(link.requiredPermission));
